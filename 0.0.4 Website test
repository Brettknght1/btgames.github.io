	...
	<body>
		<div id="page">
			<header id="header">
				<div id="header-inner">	
					<div id="logo">
						<h1><a href="#">B.T.<span> Games</span></a></h1>
					</div>
					<div id="top-nav">
						<ul>
				...
				<div id="content-inner">
					...
					<main id="contentbar">
						<div class="article">
							<h1>News</h1>
							<hr />
<h3 style="text-align: center;"><strong><span style="color: #000000;">Web 0.0.4 relesed</span></strong></h3>
<hr />
<p>&nbsp;</p>
						</div>
					</main>
			...
			<div id="footerblurb">
				<div id="footerblurb-inner">
					...
					<div class="column">
						...
						<p>-Not ready for 0.0.4-</p>
					</div>	
					<div class="column">
						<h2><span>Whats coming next?</span></h2>
						<p>-Not ready for 0.0.4-</p>
					</div>
					<div class="column">
			...
			<footer id="footer">
				<div id="footer-inner">
					<p>&copy; Copyright <a href="#">B.T. Games </a> &#124; <a href="#">Terms of Use</a> &#124; <a href="#">Privacy Policy</a></p>
					<div class="clr"></div>
				</div>
			</footer>
		</div>
